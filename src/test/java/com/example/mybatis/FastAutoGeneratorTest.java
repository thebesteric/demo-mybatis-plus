 ...
 * @author wangweijun
 * @version v1.0
 * @since 2023-11-27 17:27:34
 */
public class FastAutoGeneratorTest {
    public static void main(String[] args) {
        String url = "jdbc:mysql://127.0.0.1:3306/mybatis?useUnicode=true&characterEncoding=UTF-8&userSSL=false&serverTimezone=Asia/Shanghai";
